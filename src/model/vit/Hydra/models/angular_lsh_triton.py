...
def _flash_attn(q, proj_dir, perm, enc_vec,k,v):
    ...
    BLOCK = 128
    #block_n = triton.cdiv(seqlen_q,BLOCK)
    ...
    return o
def _angular_lsh(q, proj_dir, perm, enc_vec,k,v):
    # shape constraints
    bias=None
    causal=False
    softmax_scale=None
...
class AngularLSHTriton(torch.nn.Module):
    ...
    def hash_triton(self, q,k,v):
        return _angular_lsh(q, self.proj_dir, self.perm, self.enc_vec,k,v)
